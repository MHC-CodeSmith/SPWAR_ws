...
class MoveItSimpleNode : public rclcpp::Node {
public:
    MoveItSimpleNode() : Node("moveit_simple_node") {
        move_group_ = std::make_shared<moveit::planning_interface::MoveGroupInterface>(shared_from_this(), "spot_arm");
    }
    ...
    void moveToPose(const geometry_msgs::msg::Pose& target_pose) {
        ...
        if (move_group_->plan(plan) == moveit::core::MoveItErrorCode::SUCCESS) {
            ...
            RCLCPP_INFO(this->get_logger(), "Movimento concluído com sucesso.");
        } else {
...
int main(int argc, char* argv[]) {
    ...
    auto node = std::make_shared<MoveItSimpleNode>();
